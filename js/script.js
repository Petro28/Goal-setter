...
const deleteTaskButton = document.querySelector('[data-delete-complete-tasks]')
...
function save() {
  localStorage.setItem(LOCALE_STORAGE_LIST_KEY, JSON.stringify(lists))
  localStorage.setItem(LOCALE_STORAGE_SELECTED_LIST_ID_KEY, selectedListId)
}
